...
const openQQ= () => {
  ...
  //  const A=window.open("oauth/index.php","TencentLogin","width=450,height=320,menubar=0,scrollbars=1,resizable=1,status=1,titlebar=0,toolbar=0,location=1");
   QC.Login.showPopup({ appId: '102822211', redirectURI: 'https://sunworld.site/qq' });
}
onMounted(() => {
